...
; initialize ports
		cbi		RX_DDR, RX	;original
		;ldi r26, 0x30
        ;out DDRA, r26 
.if UseUartInvert && Use1Wire
		cbi		RX_PORT, RX
.else
		sbi		RX_PORT, RX	;original
		;ldi r26, 0x28
		;out PORTA, r26
...
BootSign:	.db		"2CHI2CSMPS"											; iff you change it then change sign in AVRootloader.ini
BootMsg:	;.db		"µLED BPaFG"											; your own message here, must be shorter as 253 chars
