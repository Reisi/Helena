...
/*
 *  reduced IM_MAX_CONN_HANDLES for lower memory consumption
 */
...
#undef BLE_GAP_WHITELIST_ADDR_MAX_COUNT
#undef BLE_GAP_WHITELIST_IRK_MAX_COUNT
#define BLE_GAP_WHITELIST_ADDR_MAX_COUNT 4
#define BLE_GAP_WHITELIST_IRK_MAX_COUNT 4

#define IM_MAX_CONN_HANDLES         3 //8
