...
#define DEVICE_NAME                          "HlnBtldr"                                              /**< Name of device. Will be included in the advertising data. */
...
static void advertising_start(void)
{
    if (!m_is_advertising)
    {
        ...
        hmi_SetLed(HMI_LED_ADVERTISING, true);
...
static void advertising_stop(void)
{
    if (m_is_advertising)
    {
        ...
        hmi_SetLed(HMI_LED_ADVERTISING, false);
...
static void on_ble_evt(ble_evt_t * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        case BLE_GAP_EVT_CONNECTED:
            hmi_SetLed(HMI_LED_ADVERTISING, false);
            hmi_SetLed(HMI_LED_CONNECTED, true);
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            {
                ...
                hmi_SetLed(HMI_LED_CONNECTED, false);
